...
"""
During rendering, each FRIDGR scene file is dumped to disk as a separate JSON
file; this is convenient for distributing rendering across multiple machines.
This script collects all FRIDGR scene files stored in a directory and combines
them into a single JSON file. This script also adds the version number, date,
and license to the output file.
"""

parser = argparse.ArgumentParser()
parser.add_argument('--input_dir', default='../fridgr-output/scenes')
parser.add_argument('--output_file', default='../fridgr-output/FRIDGR_collect_scenes.json')
