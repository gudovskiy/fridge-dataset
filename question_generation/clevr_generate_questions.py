...
# Inputs
parser.add_argument('--input_scene_file', default='../clevr-output/CLEVR_scenes.json',
    help="JSON file containing ground-truth scene information for all images " +
         "from render_images.py")
parser.add_argument('--metadata_file', default='clevr_metadata.json',
    help="JSON file containing metadata about functions")
parser.add_argument('--synonyms_json', default='clevr_synonyms.json',
...
parser.add_argument('--output_questions_file',
    default='../clevr-output/CLEVR_questions.json',
...
def precompute_filter_options(scene_struct, metadata):
  # Keys are tuples (size, color, material, shape) (where some may be None)
