...
parser.add_argument('--template_dir', default='FRIDGR_0.01_templates',
...
parser.add_argument('--templates_per_image', default=2, type=int,
    help="The number of different templates that should be instantiated " +
         "on each image")
parser.add_argument('--instances_per_template', default=21, type=int,
      ...
      for k in filter_option_keys:
        ...
        for param_name, param_val in zip(filter_side_inputs, k):
          ...
          if param_val is not None:
            ...
            if metadata['dataset'] == FRIDGR_DATASET and param_type == 'Shape':
              param_val = 'thing'
            else:
              param_val = ''
            cur_next_vals[param_name] = param_val
