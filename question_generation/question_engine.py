...
execute_handlers = {
  'scene': scene_handler,
  'filter_category': make_filter_handler('category'),
  'filter_freshness': make_filter_handler('freshness'),
  ...
  'count': count_handler,
  'query_category': make_query_handler('category'),
  'query_freshness': make_query_handler('freshness'),
  ...
  'exist': exist_handler,
  'equal_category': equal_handler,
  'equal_freshness': equal_handler,
  ...
  'same_category': make_same_attr_handler('category'),
  'same_freshness': make_same_attr_handler('freshness'),
